...
class ValidationService {
    ...
    public function __construct() {
        $this->tz = new DateTimeZone('Europe/Vienna');
    }
    ...
    public function validateEvent(array $data) : ?array {
        ...
        if (empty(trim($data['event_date']))) {
            ...
            $min_date = new DateTime('tomorrow', $this->tz);
    ...
    public function isValidEventDate(string $event_date) : bool {
        ...
        $standard_date = DateTime::createFromFormat('Y-m-d', $event_date, $this->tz);
    ...
    public function isValidReminderTime(string $reminder_time) : bool {
        ...
        foreach ($formats as $format) {
            $dt = DateTime::createFromFormat($format, $reminder_time, $this->tz);
    ...
    public function eventDateGreaterThanReminderTime(string $event_date,
        ...
        $std_event_date =DateTime::CreateFromFormat('Y-m-d' , $event_date, $this->tz);
        $std_reminder_date = 
        DateTime::CreateFromFormat('Y-m-d H:i:s', $reminder_time, $this->tz) ?: 
        DateTime::CreateFromFormat('Y-m-d\TH:i', $reminder_time, $this->tz);
